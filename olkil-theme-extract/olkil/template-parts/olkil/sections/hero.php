		...
		<div class="olkil-hero__grid">
			<div>
				...
				<div class="olkil-brand-lockup" id="olkil-brand">
					<img class="olkil-brand-lockup__logo" src="<?php echo esc_url( OLKIL_URI . 'assets/olkil/img/logo.png' ); ?>" width="72" height="72" alt="OLKIL" decoding="async" fetchpriority="high" />
