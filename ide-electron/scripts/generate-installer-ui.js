 ...
 * Writes into build/icon (electron-builder buildResources).
 *
...
const sidebarOut = path.join(root, 'build', 'icon', 'installerSidebar.bmp');
const headerOut = path.join(root, 'build', 'icon', 'installerHeader.bmp');
...
const tmp = path.join(root, 'build', 'icon', '.gen-installer-ui.ps1');
