import type { SqliteDb } from "@olkil/shared/db";

/**
 * Bootstrap the dedicated cron.db schema. Unlike @olkil/shared's
 * `ensureSessionSchema`, this schema is fully owned by @olkil/core
