...
import { loadSqliteDb, nowIso, type SqliteDb } from "@olkil/shared/db";
import { resolveDbDataDir } from "@olkil/shared/storage";
...
export class SqliteTeamStore implements TeamStore {
	...
	private ensureSchema(db: SqliteDb): void {
		...
		// Session/schedule schemas use separate migration paths in @olkil/shared.
		db.exec(`
