...
// `@olkil/shared` (see `packages/shared/dist/identifier.ts`), but
 ...
 * `@olkil/core`, which constructs models itself to share gateway/telemetry
 ...
 * runtime builds an `AgentModel` internally via `@olkil/llms`. This is the
 ...
 * construct the model itself via `@olkil/llms`.
 */
 ...
 *
 * while `@olkil/core` (which owns model construction) continues to use
