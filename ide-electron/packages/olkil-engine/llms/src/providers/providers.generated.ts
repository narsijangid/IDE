 ...
 *
 * Generated by: @olkil/llms/scripts/generate-models.ts
 *
...
export const GENERATED_PROVIDER_SPECS: readonly BuiltinSpec[] = [
  ...
  },
  {
    "id": "aki-io",
    "name": "AKI.IO",
    "description": "AKI.IO model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
    ...
    "defaultModelId": "kimi-k2.7-code-1100b",
    "apiKeyEnv": [
      "AKI_IO_API_KEY"
    ],
  ...
  },
  {
    "id": "blueclaw",
    "name": "Blue Claw",
    "description": "Blue Claw model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
  ...
  },
  {
    "id": "crossmodel",
    "name": "CrossModel",
    "description": "CrossModel model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    "id": "daoxe",
    "name": "DaoXE",
    "description": "DaoXE model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    ...
    "defaultModelId": "databricks-gpt-5-6-luna",
    "apiKeyEnv": [
      "DATABRICKS_HOST",
      "DATABRICKS_TOKEN"
    ],
  ...
  },
  {
    "id": "ebcloud",
    "name": "EBCloud",
    "description": "EBCloud model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
    ],
    "modelsProviderId": "ebcloud",
    "defaultModelId": "DeepSeek-V4-Flash",
    "apiKeyEnv": [
      "EBCLOUD_API_KEY"
    ],
  ...
  },
  {
    "id": "empiriolabs",
    "name": "EmpirioLabs AI",
    "description": "EmpirioLabs AI model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    "id": "freemodel",
    "name": "FreeModel",
    "description": "FreeModel model provider from models.dev",
    "family": "anthropic",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    "id": "hetzner",
    "name": "Hetzner",
    "description": "Hetzner model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
    ],
    "modelsProviderId": "hetzner",
    "defaultModelId": "Qwen/Qwen3.6-35B-A3B-FP8",
    "apiKeyEnv": [
      "HETZNER_API_KEY"
    ],
  ...
  },
  {
    "id": "hyper",
    "name": "Charm Hyper",
    "description": "Charm Hyper model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    "id": "inferx",
    "name": "InferX",
    "description": "InferX model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
    ],
    "modelsProviderId": "inferx",
    "defaultModelId": "qwen/qwen3.6-27b-fp8",
    "apiKeyEnv": [
      "INFERX_API_KEY"
    ],
  ...
  },
  {
    "id": "lynkr",
    "name": "Lynkr",
    "description": "Lynkr model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools"
    ],
    "modelsProviderId": "lynkr",
    "defaultModelId": "lynkr-auto",
    "apiKeyEnv": [
      "LYNKR_API_KEY"
    ],
  ...
  },
  {
    ...
    "description": "MiniMax Token Plan (minimaxi.com) model provider from models.dev",
    "family": "anthropic",
    "capabilities": [
      "tools",
      "reasoning"
  ...
  },
  {
    ...
    "description": "MiniMax Token Plan (minimax.io) model provider from models.dev",
    "family": "anthropic",
    "capabilities": [
      "tools",
      "reasoning"
  ...
  },
  {
    ...
    "description": "Model Oracle AI model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
    ],
    "modelsProviderId": "model-oracle-ai",
  ...
  },
  {
    "id": "ofox",
    "name": "Ofox",
    "description": "Ofox model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    ...
    "defaultModelId": "google/gemini-flash-latest",
    "apiKeyEnv": [
      "ORCAROUTER_API_KEY"
    ],
  ...
  },
  {
    ...
    "description": "Perplexity Agent model provider from models.dev",
    "family": "openai",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    "id": "pioneer",
    "name": "Pioneer",
    "description": "Pioneer model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    ...
    "defaultModelId": "poolside/laguna-s-2.1",
    "apiKeyEnv": [
      "POOLSIDE_API_KEY"
    ],
  ...
  },
  {
    "id": "stepfun-ai",
    "name": "StepFun (Global)",
    "description": "StepFun (Global) model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    ...
    "description": "StepFun Step Plan (Global) model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
  ...
  },
  {
    ...
    "description": "StepFun Step Plan (China) model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
  ...
  },
  {
    "id": "subconscious",
    "name": "Subconscious",
    "description": "Subconscious model provider from models.dev",
    "family": "anthropic",
    "capabilities": [
      "tools",
      "reasoning",
  ...
  },
  {
    ...
    "defaultModelId": "hf:moonshotai/Kimi-K3",
    "apiKeyEnv": [
      "SYNTHETIC_API_KEY"
    ],
  ...
  },
  {
    ...
    "description": "Thinking Machines model provider from models.dev",
    "family": "anthropic",
    "capabilities": [
      "tools",
      "reasoning",
    ...
    "modelsProviderId": "thinkingmachines",
    "defaultModelId": "thinkingmachines/Inkling",
    "apiKeyEnv": [
      "TINKER_API_KEY"
    ],
  ...
  },
  {
    "id": "unorouter",
    "name": "UnoRouter",
    "description": "UnoRouter model provider from models.dev",
    "family": "openai-compatible",
    "capabilities": [
      "tools",
      "reasoning"
    ],
    "modelsProviderId": "unorouter",
    "defaultModelId": "claude-sonnet-5",
    "apiKeyEnv": [
      "UNOROUTER_API_KEY"
    ],
  ...
  },
  {
    ...
    "defaultModelId": "claude-opus-5@default",
    "apiKeyEnv": [
