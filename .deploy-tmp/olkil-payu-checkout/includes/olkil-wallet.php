...
function olkil_payu_rest_usage( WP_REST_Request $request ) {
	...
	$input_text  = (string) $request->get_param( 'input_text' );
	$output_text = (string) $request->get_param( 'output_text' );
	$input_tok   = (int) $request->get_param( 'input_tokens' );
	$output_tok  = (int) $request->get_param( 'output_tokens' );
	$tokens      = (int) $request->get_param( 'tokens' );
