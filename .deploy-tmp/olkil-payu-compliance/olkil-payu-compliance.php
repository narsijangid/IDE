...
<li><strong>Website:</strong> <a href=\"{$w}\">{$w}</a></li>
	...
	$pages['about-us'] = array(
		'title'   => 'About Us',
		'content' => "<p><strong>{$t}</strong> is an AI-powered code editor and IDE product based in India.</p>
...
<p>For support or business queries, email <a href=\"mailto:{$e}\">{$e}</a>" . ( $m_tel !== '' ? " or call {$m_html}" : '' ) . ".</p>",
	...
	$pages['contact'] = array(
		'title'   => 'Contact Us',
		'content' => "<p>Contact <strong>{$t}</strong> for product, billing, refund, cancellation, or partnership queries.</p>
...
OLKIL provides digital delivery only — access is activated online after successful payment (typically instant to within 24 hours).</p>
...
<p>OLKIL software, branding, and website content are owned by or licensed to {$t}. You retain ownership of your own code.</p>
...
function olkil_payu_remove_shipping_page() {
...
function olkil_payu_sync_pages() {
	...
	olkil_payu_remove_shipping_page();
